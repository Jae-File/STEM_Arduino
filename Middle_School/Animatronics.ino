// This is the base program for the Fundamentals domain (animatronic creatures).
// It introduces the structure of a typical Arduino program and lets you control a servo motor.
...
////// SWEEP(): HOW WE MOVE OUR SERVO MOTOR
  ...
  sweep(myservo, 0, 9);    // sweep our servo back to 0 degrees at a slower speed.
  delay(500);             // wait again before doing anything else.


}                 // End of loop(). The program will start over from the beginning of loop()!
