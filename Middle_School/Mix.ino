...
////// IF STATEMENTS: USING OUR SENSOR READING TO MAKE SOMETHING HAPPEN 
  ...
  if (sensorReading < 800) {           // If the sensor is giving values less than 100, we will do all the code between these {   }.
...
/////// 360-DEGREE SERVO CONTROL
  ...
  int i = sensorReading/8; // divide it by 8 and call it "i", higher numbers will make it blink faster
